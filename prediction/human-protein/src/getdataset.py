...
def getdataset_iFeature(namelist_file, feature_type, y_lable, datapath, nproteins):
...
def getdataset_dscript(namelist_file, feature_type, y_lable, feature_datapath, nproteins):
...
# ###############################################################    
def printesmFeature(namelist_file, feature_type, datapath):
