...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-GDPC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-GDPC-roc' + str(i) + '.png' 
        ...
        figure_file = 'gradientboost-GDPC-recall' + str(i) + '.png'
        ...
        figure_file = 'gradientboost-GDPC-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
