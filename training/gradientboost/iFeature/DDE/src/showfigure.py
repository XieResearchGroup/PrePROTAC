...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = GradientBoostingClassifier(max_depth=6, min_samples_split=8, min_samples_leaf=2, n_estimators=400)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-DDE' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-DDE-roc' + str(i) + '.png' 
        ...
        figure_file = 'gradientboost-DDE-recall' + str(i) + '.png'
        ...
        figure_file = 'gradientboost-DDE-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
