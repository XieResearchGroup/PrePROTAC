...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = GradientBoostingClassifier(max_depth=9, min_samples_split=4, min_samples_leaf=1, n_estimators=100)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-AAC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-AAC-roc' + str(i) + '.png' 
        ...
        figure_file = 'gradientboost-AAC-recall' + str(i) + '.png'
        ...
        figure_file = 'gradientboost-AAC-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
