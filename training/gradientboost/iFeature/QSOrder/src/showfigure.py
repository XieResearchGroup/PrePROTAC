...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = GradientBoostingClassifier(max_depth=7, min_samples_split=6, min_samples_leaf=1, n_estimators=200)
...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        figure_file = 'randomforest-esm-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'randomforest-esm-recall' + str(i) + '.jpg'
        ...
        figure_file = 'randomforest-esm-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def ridge_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        figure_file = 'ridge-esm-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'ridge-esm-recall' + str(i) + '.jpg'
        ...
        figure_file = 'ridge-esm-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
    average_auc = average_auc / NUM_TRIALS   
    print("average auc: ", average_auc)
