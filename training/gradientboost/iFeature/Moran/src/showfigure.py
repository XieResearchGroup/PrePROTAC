...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = GradientBoostingClassifier(max_depth=5, min_samples_split=4, min_samples_leaf=2, n_estimators=200)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-Moran' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-Moran-roc' + str(i) + '.png' 
        ...
        figure_file = 'gradientboost-Moran-recall' + str(i) + '.png'
        ...
        figure_file = 'gradientboost-Moran-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
