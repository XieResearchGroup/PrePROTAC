...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = GradientBoostingClassifier(max_depth=5, min_samples_split=2, min_samples_leaf=1, n_estimators=400)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-KSCTriad' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-KSCTriad-roc' + str(i) + '.png' 
        ...
        figure_file = 'gradientboost-KSCTriad-recall' + str(i) + '.png'
        ...
        figure_file = 'gradientboost-KSCTriad-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
