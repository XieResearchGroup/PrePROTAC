...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = GradientBoostingClassifier(max_depth=10, min_samples_split=10, min_samples_leaf=3, n_estimators=200)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-GAAC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-GAAC-roc' + str(i) + '.png' 
        ...
        figure_file = 'gradientboost-GAAC-recall' + str(i) + '.png'
        ...
        figure_file = 'gradientboost-GAAC-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
