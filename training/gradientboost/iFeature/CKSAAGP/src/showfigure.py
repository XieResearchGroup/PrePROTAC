...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = GradientBoostingClassifier(max_depth=7, min_samples_split=10, min_samples_leaf=1, n_estimators=300)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-CKSAAGP' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-CKSAAGP-roc' + str(i) + '.png' 
        ...
        figure_file = 'gradientboost-CKSAAGP-recall' + str(i) + '.png'
        ...
        figure_file = 'gradientboost-CKSAAGP-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
