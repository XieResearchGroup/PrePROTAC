...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = GradientBoostingClassifier(max_depth=4, min_samples_split=2, min_samples_leaf=1, n_estimators=400)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-Ctriad' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-Ctriad-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'gradientboost-Ctriad-recall' + str(i) + '.jpg'
        ...
        figure_file = 'gradientboost-Ctriad-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
