...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = GradientBoostingClassifier(max_depth=8, min_samples_split=10, min_samples_leaf=1, n_estimators=400)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-APAAC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-APAAC-roc' + str(i) + '.png' 
        ...
        figure_file = 'gradientboost-APAAC-recall' + str(i) + '.png'
        ...
        figure_file = 'gradientboost-APAAC-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
