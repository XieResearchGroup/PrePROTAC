...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = GradientBoostingClassifier(max_depth=7, min_samples_split=8, min_samples_leaf=2, n_estimators=300)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-dscript' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-dscript-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'gradientboost-dscript-recall' + str(i) + '.jpg'
        ...
        figure_file = 'gradientboost-dscript-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-dscript' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-dscript-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'randomforest-dscript-recall' + str(i) + '.jpg'
        ...
        figure_file = 'randomforest-dscript-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def ridge_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'ridge-dscript' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'ridge-dscript-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'ridge-dscript-recall' + str(i) + '.jpg'
        ...
        figure_file = 'ridge-dscript-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
    average_auc = average_auc / NUM_TRIALS   
    print("average auc: ", average_auc)
