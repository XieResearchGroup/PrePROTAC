...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=8, min_samples_split=6, min_samples_leaf=2, n_estimators=200)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-CKSAAGP' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-CKSAAGP-roc' + str(i) + '.png' 
        ...
        figure_file = 'randomforest-CKSAAGP-recall' + str(i) + '.png'
        ...
        figure_file = 'randomforest-CKSAAGP-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
