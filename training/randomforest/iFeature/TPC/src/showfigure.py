...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-TPC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-TPC-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'gradientboost-TPC-recall' + str(i) + '.jpg'
        ...
        figure_file = 'gradientboost-TPC-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=9, min_samples_split=8, min_samples_leaf=4, n_estimators=200)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-TPC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-TPC-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'randomforest-TPC-recall' + str(i) + '.jpg'
        ...
        figure_file = 'randomforest-TPC-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def ridge_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'ridge-TPC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'ridge-TPC-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'ridge-TPC-recall' + str(i) + '.jpg'
        ...
        figure_file = 'ridge-TPC-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
    average_auc = average_auc / NUM_TRIALS   
    print("average auc: ", average_auc)
