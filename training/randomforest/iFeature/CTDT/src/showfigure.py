...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=7, min_samples_split=8, min_samples_leaf=4, n_estimators=100)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-CTDT' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-CTDT-roc' + str(i) + '.png' 
        ...
        figure_file = 'randomforest-CTDT-recall' + str(i) + '.png'
        ...
        figure_file = 'randomforest-CTDT-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
