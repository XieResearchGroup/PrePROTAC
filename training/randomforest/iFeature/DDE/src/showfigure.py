...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=10, min_samples_split=10, min_samples_leaf=1, n_estimators=200)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-DDE' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-DDE-roc' + str(i) + '.png' 
        ...
        figure_file = 'randomforest-DDE-recall' + str(i) + '.png'
        ...
        figure_file = 'randomforest-DDE-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
