...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=10, min_samples_split=4, min_samples_leaf=3, n_estimators=100)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-SOCNumber' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-SOCNumber-roc' + str(i) + '.png' 
        ...
        figure_file = 'randomforest-SOCNumber-recall' + str(i) + '.png'
        ...
        figure_file = 'randomforest-SOCNumber-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
