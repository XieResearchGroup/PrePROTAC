...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=7, min_samples_split=4, min_samples_leaf=2, n_estimators=300)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-DPC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-DPC-roc' + str(i) + '.png' 
        ...
        figure_file = 'randomforest-DPC-recall' + str(i) + '.png'
        ...
        figure_file = 'randomforest-DPC-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
