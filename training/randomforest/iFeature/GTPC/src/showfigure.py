...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-GTPC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-GTPC-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'gradientboost-GTPC-recall' + str(i) + '.jpg'
        ...
        figure_file = 'gradientboost-GTPC-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=8, min_samples_split=2, min_samples_leaf=4, n_estimators=200)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-GTPC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-GTPC-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'randomforest-GTPC-recall' + str(i) + '.jpg'
        ...
        figure_file = 'randomforest-GTPC-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def ridge_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'ridge-GTPC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'ridge-GTPC-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'ridge-GTPC-recall' + str(i) + '.jpg'
        ...
        figure_file = 'ridge-GTPC-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
    average_auc = average_auc / NUM_TRIALS   
    print("average auc: ", average_auc)
