...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=7, min_samples_split=4, min_samples_leaf=1, n_estimators=400)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-CKSAAP' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-CKSAAP-roc' + str(i) + '.png' 
        ...
        figure_file = 'randomforest-CKSAAP-recall' + str(i) + '.png'
        ...
        figure_file = 'randomforest-CKSAAP-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
