...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-QSOrder' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-QSOrder-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'gradientboost-QSOrder-recall' + str(i) + '.jpg'
        ...
        figure_file = 'gradientboost-QSOrder-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=9, min_samples_split=6, min_samples_leaf=1, n_estimators=400)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-QSOrder' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-QSOrder-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'randomforest-QSOrder-recall' + str(i) + '.jpg'
        ...
        figure_file = 'randomforest-QSOrder-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def ridge_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'ridge-QSOrder' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'ridge-QSOrder-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'ridge-QSOrder-recall' + str(i) + '.jpg'
        ...
        figure_file = 'ridge-QSOrder-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
    average_auc = average_auc / NUM_TRIALS   
    print("average auc: ", average_auc)
