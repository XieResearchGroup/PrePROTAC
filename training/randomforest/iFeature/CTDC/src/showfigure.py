...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=9, min_samples_split=2, min_samples_leaf=1, n_estimators=300)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-CTDC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-CTDC-roc' + str(i) + '.png' 
        ...
        figure_file = 'randomforest-CTDC-recall' + str(i) + '.png'
        ...
        figure_file = 'randomforest-CTDC-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
