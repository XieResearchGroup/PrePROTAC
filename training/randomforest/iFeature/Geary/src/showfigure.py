...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-Geary' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-Geary-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'gradientboost-Geary-recall' + str(i) + '.jpg'
        ...
        figure_file = 'gradientboost-Geary-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-Geary' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-Geary-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'randomforest-Geary-recall' + str(i) + '.jpg'
        ...
        figure_file = 'randomforest-Geary-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def ridge_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'ridge-Geary' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'ridge-Geary-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'ridge-Geary-recall' + str(i) + '.jpg'
        ...
        figure_file = 'ridge-Geary-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
    average_auc = average_auc / NUM_TRIALS   
    print("average auc: ", average_auc)
