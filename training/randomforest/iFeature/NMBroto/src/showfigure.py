...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=8, min_samples_split=2, min_samples_leaf=3, n_estimators=100)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-NMBroto' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-NMBroto-roc' + str(i) + '.png' 
        ...
        figure_file = 'randomforest-NMBroto-recall' + str(i) + '.png'
        ...
        figure_file = 'randomforest-NMBroto-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
