...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=8, min_samples_split=2, min_samples_leaf=1, n_estimators=200)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-APAAC' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-APAAC-roc' + str(i) + '.png' 
        ...
        figure_file = 'randomforest-APAAC-recall' + str(i) + '.png'
        ...
        figure_file = 'randomforest-APAAC-fpr' + str(i) + '.png'
        plt.savefig(figure_file)
