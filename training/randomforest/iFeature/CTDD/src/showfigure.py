...
def gradientboost_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'gradientboost-CTDD' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'gradientboost-CTDD-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'gradientboost-CTDD-recall' + str(i) + '.jpg'
        ...
        figure_file = 'gradientboost-CTDD-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def randomforest_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    base_estimator = RandomForestClassifier(max_depth=10, min_samples_split=2, min_samples_leaf=1, n_estimators=300)
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'randomforest-CTDD' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'randomforest-CTDD-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'randomforest-CTDD-recall' + str(i) + '.jpg'
        ...
        figure_file = 'randomforest-CTDD-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
...
def ridge_ROC_fpr_recallcurve(Xdataset, ydataset):
    ...
    for i in range(NUM_TRIALS):
        ...
        for j, (train, test) in enumerate(cv.split(Xdataset, ydataset)):
            ...
            modelfile = 'ridge-CTDD' + str(i) + '_' + str(j) + '.pkl'
        ...
        figure_file = 'ridge-CTDD-roc' + str(i) + '.jpg' 
        ...
        figure_file = 'ridge-CTDD-recall' + str(i) + '.jpg'
        ...
        figure_file = 'ridge-CTDD-fpr' + str(i) + '.jpg'
        plt.savefig(figure_file, dpi=600)
    average_auc = average_auc / NUM_TRIALS   
    print("average auc: ", average_auc)
